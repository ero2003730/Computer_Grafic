/*
  ...
  156474
  Exercicio 2 - Proposta de Exercícios 01 - Bresenham para traçado de linhas
*/
...
void draw()
{
    ...
    if (triangulo == false && click == 1)
    {
        ...
        bresenham_algorithm(x_1, y_1, x_2, y_2); // Desenha uma linha usando Bresenham
        glEnd();                                 // Finaliza o modo de desenho de pontos
    }

    // Desenha um triângulo se 'triangulo' for verdadeiro e 'click' for 2
    if (triangulo == true && click == 2)
    {
        glBegin(GL_POINTS);                      // Inicia o modo de desenho de pontos
        bresenham_algorithm(x_1, y_1, x_2, y_2); // Desenha a primeira linha do triângulo
        bresenham_algorithm(x_2, y_2, x_3, y_3); // Desenha a segunda linha do triângulo
        bresenham_algorithm(x_3, y_3, x_1, y_1); // Desenha a terceira linha do triângulo
        glEnd();                                 // Finaliza o modo de desenho de pontos
    }
    glFlush();
}
